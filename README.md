...
<header>
      <h1>Event hub for artist</h1>
        <nav>
          <p>Ready for an exciting months of events?Get ready and have a blast on your strive and passion on interacting with the community.
            <ul>
...
<section id="upcoming-events">
  <h2>Upcoming Events</h2>
    <p>These are the upcoming events that would be coming out. If you have any suggestions go to the <a href="" target="_blank">Suggestion Box</a>
      <nav>
        <ul>
            <li><a href="#art-fight">Art Fight</a></li>
            <li><a href="#Show-off-your-art">
            Show off you art</a></li>
        </ul>
